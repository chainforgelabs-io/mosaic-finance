...
export async function generatePDF(
  ...
  .draft-watermark { position: fixed; top: 35%; left: 50%; transform: translate(-50%, -50%) rotate(-35deg); font-size: 120px; font-weight: 900; color: rgba(200, 0, 0, 0.08); letter-spacing: 12px; pointer-events: none; z-index: 9999; white-space: nowrap; }
    ...
    html = html.replace(
      'Reviewed by a Registered Financial Professional',
  ...
  const headerText = options?.draft
    ? 'MOSAIC FINANCE — DRAFT PLAN (UNVERIFIED)'
    : 'MOSAIC FINANCE — CONFIDENTIAL FINANCIAL PLAN';
  const footerText = options?.draft
    ? 'DRAFT — This plan has NOT been reviewed by a registered financial professional. For educational purposes only.'
...
<div class="cover">
  <div class="cover-inner">
    <div class="brand">MOSAIC FINANCE</div>
    <h1>PERSONAL<br>FINANCIAL PLAN</h1>
    <div class="subtitle">Comprehensive Planning Report</div>
    <div class="gold-line"></div>
    <div class="meta">${dateStr}</div>
    <div class="meta" style="margin-top:4px;">Reviewed by a Registered Financial Professional</div>
  </div>
</div>
...
<div class="page">
  ...
  <div class="disclaimer">
    <strong>IMPORTANT DISCLAIMER:</strong> This report was generated by Mosaic Finance, an artificial intelligence financial planning tool, and reviewed by a registered financial professional. It does not constitute registered investment advice under applicable Canadian securities legislation. The information contained herein is for educational and planning purposes only. Past performance of any investment referenced is not indicative of future results. Users should consult a registered investment advisor, tax professional, and insurance specialist before acting on any information contained in this report. Mosaic Finance is a product of ChainForge Labs. Generated: ${new Date().toISOString()}
  </div>
</div>
