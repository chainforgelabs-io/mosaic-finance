...
<div class="section">
  ...
  <div class="data-grid">
    ...
    <div class="data-card"><div class="label">RRSP Contribution Consideration</div><div class="value">$${fmt(ter.rrsp_contribution_recommendation)}</div></div>
  </div>
...
<div class="section">
  ...
  <div class="data-grid">
    ...
    <div class="data-card"><div class="label">Suggested Method</div><div class="value">${dep.recommended_method ?? '—'}</div></div>
  </div>
...
<div class="section">
  ...
  <h3 style="font-size:14px;">Coverage Considerations</h3>
