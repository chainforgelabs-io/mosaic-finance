/**
 * Static S&P 500 constituent universe for control-group sampling.
 * Source: Wikipedia "List of S&P 500 companies", captured 2026-07-04.
 * Version-controlled on purpose: the sampling universe is reproducible and
 * documented (see docs/export-api.md for the survivorship caveat).
 * Symbols use dot notation for share classes (BRK.B) to match FMP/Finnhub.
 */
export const SP500_UNIVERSE_AS_OF = "2026-07-04";
