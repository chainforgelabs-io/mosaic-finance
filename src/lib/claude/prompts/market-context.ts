...
export function buildMarketContextPrompt(
  ...
  return `You are a financial research analyst producing a weekly market context briefing for a Canadian investor. This briefing is educational context — NOT a prediction, recommendation, or financial advice.
...
2. RELEVANT SECTORS (2-3 sentences per sector): Sectors relevant to the user's portfolio composition. What's driving performance. Any notable changes.

3. PORTFOLIO-SPECIFIC CONTEXT (3-4 sentences): How current market conditions relate specifically to the user's holdings and risk profile. Not advice — educational context.
